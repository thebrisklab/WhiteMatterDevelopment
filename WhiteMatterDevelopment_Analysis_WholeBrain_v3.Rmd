...
, hide.label=TRUE,main='A',xlim=c(35,41),ylim=c(0.125,0.21),rug=FALSE,col='slateblue1')

focal_chron=90
plot_smooth(model0.fa, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain FA ',xlab='Gestational age at birth (weeks)'
, hide.label=TRUE,main='A',xlim=c(35,41),rug=FALSE,col='slateblue3',add=TRUE)

focal_chron=180
plot_smooth(model0.fa, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain FA ',xlab='Gestational age at birth (weeks)'
, hide.label=TRUE,main='A',xlim=c(35,41),rug=FALSE,col='darkslateblue',add=TRUE)

legend(x='bottomright',legend=c('30 days','90 days','180 days'),lty=1,lwd=2,col=c('slateblue1','slateblue3','darkslateblue'),bty='n')

focal_chron=30
plot_smooth(model0.md, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='B',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(0.95,1.4))

focal_chron=90
plot_smooth(model0.md, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD ',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='B',xlim=c(35,41),rug=FALSE,col='slateblue3',ylim=c(0.95,1.4),add=TRUE)

focal_chron=180
plot_smooth(model0.md, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='B',xlim=c(35,41),rug=FALSE,col='darkslateblue',ylim=c(0.95,1.4),add=TRUE)

focal_chron=30
plot_smooth(model0.ad, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='C',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(1.2,1.6))

focal_chron=90
plot_smooth(model0.ad, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD  age',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='C',xlim=c(35,41),rug=FALSE,col='slateblue3',add=TRUE)

focal_chron=180
plot_smooth(model0.ad, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='C',xlim=c(35,41),rug=FALSE,col='darkslateblue',add=TRUE)

focal_chron=30
plot_smooth(model0.rd, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='D',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(0.85,1.3))

focal_chron=90
plot_smooth(model0.rd, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='D',xlim=c(35,41),rug=FALSE,col='slateblue3',add=TRUE)

focal_chron=180
plot_smooth(model0.rd, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='D',xlim=c(35,41),rug=FALSE,col='darkslateblue',add=TRUE)
