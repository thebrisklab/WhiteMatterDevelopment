...
# Edited 12 June 2022
    model0 = gam(feature~Scanner+s(Corr_age,by=Scanner)+Sex+s(Mean_RMS)+s(Unique_ID,bs='re')+s(Family_ID,bs='re'),method='REML',data=dataset)

  model0.harm = gam(feature.combat~Scanner+s(Corr_age,by=Scanner)+Sex+s(Mean_RMS)+s(Unique_ID,bs='re')+s(Family_ID,bs='re')+Scanner,method='REML',data=dataset)
...
```{r,eval=TRUE}
examine_combat_corrage(dat_harmonized$AF_fa,dat_harmonized$AF_fa.combat,dat_harmonized,xlab='Corrected Age (days)',ylab='fa')

examine_combat_corrage(dat_harmonized$CCg_fa,dat_harmonized$CCg_fa.combat,dat_harmonized,xlab='Corrected Age (days)',ylab='fa')

examine_combat_corrage(dat_harmonized$CCg_md,dat_harmonized$CCg_md.combat,dat_harmonized,xlab='Corrected Age (days)',ylab='fa')

examine_combat_corrage(dat_harmonized$PT_rd,dat_harmonized$PT_rd.combat,dat_harmonized,xlab='Corrected Age (days)',ylab='fa')

```



Examine a few of the trajectories in the lateralized version of the ROIs. These results are not in the current version of the manuscript:
```{r,eval=TRUE}
examine_combat_corrage(dat_harmonized$AF_R_fa,dat_harmonized$AF_R_fa.combat,dat_harmonized,xlab='Corrected Age (days)',ylab='fa')

examine_combat_corrage(dat_harmonized$Fx_L_md,dat_harmonized$Fx_L_md.combat,dat_harmonized,xlab='Corrected Age (days)',ylab='fa')

examine_combat_corrage(dat_harmonized$IFOF_L_ad,dat_harmonized$IFOF_L_ad.combat,dat_harmonized,xlab='Corrected Age (days)',ylab='fa')

examine_combat_corrage(dat_harmonized$PT_R_rd,dat_harmonized$PT_R_rd.combat,dat_harmonized,xlab='Corrected Age (days)',ylab='fa')
