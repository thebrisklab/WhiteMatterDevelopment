...
library(ggplot2)
library(gridExtra)
p1=ggplot(df_comb[df_comb$mah_type==3,], aes(x=Corr_age, y=mah_dis,col=Region)) + geom_point(size=0.1) + scale_color_manual(values=regionsColor)+labs(x='Corrected age (days)',y='Mahalanobis Distance',title='B')+theme_classic()+theme(plot.title = element_text(hjust = 0.5,face='bold'))
...
p4 = ggplot(cor.dat, aes(x = Corr_age, y = Correlation)) +  geom_smooth(method = "loess", se = FALSE)+labs(y = 'Correlation', x = 'Corrected age (days)', title='E')  +theme(plot.title = element_text(hjust = 0.5,face='bold'))
...
p1=ggplot(df_comb[df_comb$mah_type==2,], aes(x=Corr_age, y=mah_dis, col=Region)) + geom_point(size=0.1) + scale_color_manual(values=regionsColor)+labs(x='Corrected age (days)',y='Mahalanobis Distance',title='B')+theme_classic()+theme(plot.title = element_text(hjust = 0.5,face='bold'))
