...
plot_smooth(model0, view="chor_age", cond=list(GA=36),xlab='Chronological Age',col='purple')
plot_smooth(model0, view="chor_age", cond=list(GA=40),xlab='Chronological Age',col='blue',add=TRUE)
```
