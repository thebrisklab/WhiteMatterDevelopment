...
TO DO:
-add f'(x)/f(x)
-add description at 0, 100, and 200
...
gam.check(model0.md) # edf are all far from k', so the default k's suffice. 
summary(model0.md)
...
```
There is no interaction between chronological and gestation age on AD. 
...
### Plots of gestational age at the average chronological age:
```{r}
tiff('../Figures/GestationalAge.tiff',width=1080,height=320,pointsize=18)
par(mfrow=c(1,4))
med_chron=median(dat_harmonized$chor_age)
plot_smooth(model0.fa, view="GA",cond=list(chor_age=med_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain FA',xlab='Gestational age',hide.label=TRUE,main='A',xlim=c(35,41),rug=FALSE)

plot_smooth(model0.md, view="GA",cond=list(chor_age=med_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD',xlab='Gestational age',hide.label=TRUE,main='B',xlim=c(35,41),rug=FALSE)

plot_smooth(model0.ad, view="GA",cond=list(chor_age=med_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD',xlab='Gestational age',hide.label=TRUE,main='C',xlim=c(35,41),rug=FALSE)

plot_smooth(model0.rd, view="GA",cond=list(chor_age=med_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age',hide.label=TRUE,main='D',xlim=c(35,41),rug=FALSE)
...
plot_smooth(model0.fa, view="chor_age",cond=list(GA=35),col=cColors[1],rug=FALSE,ylim=c(0.12,0.205),lwd=2,se=0,ylab='Whole-brain FA',xlab='Chronological age (days)',hide.label=TRUE,main='E',xlim=c(10,202))
...
######### MD:
plot_smooth(model0.md, view="chor_age", se=0, cond=list(GA=35),ylab='Whole-brain MD',xlab='Chronological age (days)',hide.label=TRUE,col=cColors[1],rug=FALSE,main='F',lwd=2,ylim=c(1,1.5))
...
######### AD:
plot_smooth(model0.ad, view="chor_age", se=0,ylab='Whole-brain AD',xlab='Chronological age (days)',hide.label=TRUE, cond=list(GA=35),col=cColors[1],rug=FALSE,main='G',lwd=2,ylim=c(1.2,1.65))
...
######### RD:
plot_smooth(model0.rd, view="chor_age", se=0, cond=list(GA=35),hide.label=TRUE,xlab='Chronological age (days)',ylab='Whole-brain RD',col=cColors[1],add=FALSE,rug=FALSE, ylim=c(0.9,1.35),main='H',lwd=2)
...
par(mfrow=c(1,4))
plot_smooth(model.sex.fa, view="Corr_age", cond=list(Sex='M'), col='blue',print.summary=FALSE,hide.label=TRUE,ylab='Whole-brain FA',xlab='Corrected age',sim.ci=TRUE,main='I')
...
plot_smooth(model.sex.md, view="Corr_age", cond=list(Sex='M'), col='blue',print.summary=FALSE,hide.label=TRUE,ylab='Whole-brain MD',xlab='Corrected age',sim.ci=TRUE,main='J')
plot_smooth(model.sex.md,view="Corr_age",cond=list(Sex='F'),col='red',print.summary=FALSE,add=TRUE,sim.ci=TRUE)

plot_smooth(model.sex.ad, view="Corr_age", cond=list(Sex='M'), col='blue',print.summary=FALSE,hide.label=TRUE,ylab='Whole-brain AD',xlab='Corrected age',sim.ci=TRUE,main='K')
plot_smooth(model.sex.ad,view="Corr_age",cond=list(Sex='F'),col='red',print.summary=FALSE,add=TRUE,sim.ci=TRUE)

plot_smooth(model.sex.rd, view="Corr_age", cond=list(Sex='M'), col='blue',print.summary=FALSE,hide.label=TRUE,ylab='Whole-brain RD',xlab='Corrected age',sim.ci=TRUE,main='L')
...
par(mfrow=c(1,4))
plot_smooth(model.fa.simple,view="Corr_age",print.summary=FALSE,hide.label=TRUE,sim.ci=TRUE,ylab="Whole-brain FA",xlab="Corrected age",rug=FALSE,main='A',col='slateblue',ylim=c(0.125,0.21))
...
plot_smooth(model.fa.simple,view="Corr_age",print.summary=FALSE,hide.label=TRUE,sim.ci=TRUE,ylab="Whole-brain FA",xlab="Corrected age",rug=FALSE,main='A',col='slateblue',ylim=c(0.125,0.21),add=TRUE)
  

plot_smooth(model.md.simple,view="Corr_age",print.summary=FALSE,hide.label=TRUE,sim.ci=TRUE,ylab="Whole-brain MD",xlab="Corrected age",rug=FALSE,main='B',col='slateblue',ylim=c(0.875,1.35))
for (i in subjectList) {
  temp = dat_harmonized[dat_harmonized$Unique_ID==i,]
  lines(temp$WB_md.combat~temp$Corr_age,col='gray',type='b',pch=20)
}
plot_smooth(model.md.simple,view="Corr_age",print.summary=FALSE,hide.label=TRUE,sim.ci=TRUE,ylab="Whole-brain MD",xlab="Corrected age",rug=FALSE,main='B',col='slateblue',add=TRUE)



plot_smooth(model.ad.simple,view="Corr_age",print.summary=FALSE,hide.label=TRUE,sim.ci=TRUE,ylab="Whole-brain AD",xlab="Corrected age",rug=FALSE,main='C',col='slateblue',ylim=c(1.1,1.6))
for (i in subjectList) {
  temp = dat_harmonized[dat_harmonized$Unique_ID==i,]
  lines(temp$WB_ad.combat~temp$Corr_age,col='gray',type='b',pch=20)
}
plot_smooth(model.ad.simple,view="Corr_age",print.summary=FALSE,hide.label=TRUE,sim.ci=TRUE,ylab="Whole-brain AD",xlab="Corrected age",rug=FALSE,main='C',col='slateblue',add=TRUE)


plot_smooth(model.rd.simple,view="Corr_age",print.summary=FALSE,hide.label=TRUE,sim.ci=TRUE,ylab="Whole-brain RD",xlab="Corrected age",rug=FALSE,main='D',col='slateblue',ylim=c(0.8,1.3))
for (i in subjectList) {
  temp = dat_harmonized[dat_harmonized$Unique_ID==i,]
  lines(temp$WB_rd.combat~temp$Corr_age,col='gray',type='b',pch=20)
}

plot_smooth(model.rd.simple,view="Corr_age",print.summary=FALSE,hide.label=TRUE,sim.ci=TRUE,ylab="Whole-brain RD",xlab="Corrected age",rug=FALSE,main='D',col='slateblue',add=TRUE)
