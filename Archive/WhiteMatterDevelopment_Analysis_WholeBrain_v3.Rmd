...
plot(derivative~data,data=der.fa,type='l',col='slateblue',lwd=1.5,main='E',ylab='FA rate of change (FA/day)',xlab='Corrected age (days)',ylim=c(-2e-04,1e-03))
polygon(x = c(der.fa$data, rev(der.fa$data)), y = c(der.fa$lower, rev(der.fa$upper)), col =  adjustcolor("slateblue", alpha.f = 0.20), border = NA)
...
p1 =  der.fa %>%
   ggplot(aes(y = derivative, x = data)) +
     ...
     labs(y = "FA rate of change (FA/day)",x='Corrected age (days)',title = "E") +
...
p2 =  der.md %>%
   ggplot(aes(y = derivative, x = data)) +
     geom_ribbon(aes(ymin = lower, ymax = upper),
                 alpha = 0.2, fill = "slateblue") +
     geom_line(colour = "slateblue", size = 1.5) +
     labs(y = "MD rate of change (MD/day)",x='Corrected age (days)',title = "F") +
     theme_classic()+geom_hline(yintercept=0)+theme(plot.title = element_text(hjust = 0.5,face='bold'))
...
p3 =  der.ad %>%
   ggplot(aes(y = derivative, x = data)) +
     geom_ribbon(aes(ymin = lower, ymax = upper),
                 alpha = 0.2, fill = "slateblue") +
     geom_line(colour = "slateblue", size = 1.5) +
     labs(y = "AD rate of change (AD/day)",x='Corrected age (days)',title = "G") +
     theme_classic()+geom_hline(yintercept=0)+theme(plot.title = element_text(hjust = 0.5,face='bold'))
...
p4 =  der.rd %>%
   ggplot(aes(y = derivative, x = data)) +
     geom_ribbon(aes(ymin = lower, ymax = upper),
                 alpha = 0.2, fill = "slateblue") +
     geom_line(colour = "slateblue", size = 1.5) +
     labs(y = "RD rate of change (RD/day)",x='Corrected age (days)',title = "H") +
     theme_classic()+geom_hline(yintercept=0)+theme(plot.title = element_text(hjust = 0.5,face='bold'))
...
vis.gam(model0.fa,view=c('chor_age','GA'),theta=-45,phi=30,ticktype='detailed',xlab='Chronological age (days)',ylab='Gestational age (weeks)',zlab='Whole-brain FA',color='terrain',main='A')

cColors = viridis::plasma(15)

plot_smooth(model0.fa, view="chor_age",cond=list(GA=35),col=cColors[1],rug=FALSE,ylim=c(0.12,0.205),lwd=2,se=0,ylab='Whole-brain FA',xlab='Chronological age (days)',hide.label=TRUE,main='B',xlim=c(0,200))
...
plot_smooth(model0.fa, view="chor_age",cond=list(GA=35),col=cColors[1],rug=FALSE,ylim=c(0.12,0.205),lwd=2,se=0,ylab='Whole-brain FA',xlab='Chronological age (days)',hide.label=TRUE,main='D',xlim=c(0,200))
...
######### FA:
cColors = viridis::plasma(15)
plot_smooth(model0.fa, view="chor_age",cond=list(GA=35),col=cColors[1],rug=FALSE,ylim=c(0.12,0.205),lwd=2,se=0,ylab='Whole-brain FA',xlab='Chronological age (days)',hide.label=TRUE,main='A',,xlim=c(0,200))
...
######### MD:
plot_smooth(model0.md, view="chor_age", se=0, cond=list(GA=35),ylab='Whole-brain MD',xlab='Chronological age (days)',hide.label=TRUE,col=cColors[1],rug=FALSE,main='B',lwd=2,ylim=c(1,1.5),xlim=c(0,200))
...
######### AD:
plot_smooth(model0.ad, view="chor_age", se=0,ylab='Whole-brain AD',xlab='Chronological age (days)',hide.label=TRUE, cond=list(GA=35),col=cColors[1],rug=FALSE,main='C',lwd=2,ylim=c(1.2,1.65),xlim=c(0,200))
...
######### RD:
plot_smooth(model0.rd, view="chor_age", se=0, cond=list(GA=35),hide.label=TRUE,xlab='Chronological age (days)',ylab='Whole-brain RD',col=cColors[1],add=FALSE,rug=FALSE, ylim=c(0.9,1.35),main='D',lwd=2,xlim=c(0,200))
