...
p3.b = p3+geom_ribbon(aes(ymin= lower, ymax = upper, fill=Region), alpha=0.1, linetype=0)+scale_fill_manual(values=regionsColor)+theme(plot.title = element_text(hjust = 0.5,face='bold')) + theme(legend.position = "none")
```
...
for (t in age.vector) {
  ...
  temp.b = der.data%>%filter(abs(der.data$data-t)<1e-5) # some v minor difference in age
...
tiff('../Figures/TractSpecificMahDistanceFAADRD_NoBands.tiff',width=1080,height=320,pointsize=18)
grid.arrange(p1,p2,p3,p4,nrow=1)
dev.off()

tiff('../Figures/TractSpecificMahDistanceFAADRD_Bands.tiff',width=1080,height=320,pointsize=18)
...
tiff('../Figures/TractSpecificMahDistanceADRD_NoBands.tiff',width=1080,height=320,pointsize=18)
grid.arrange(p1,p2,p3,p4,nrow=1)
dev.off()

tiff('../Figures/TractSpecificMahDistanceADRD_Bands.tiff',width=1080,height=320,pointsize=18)
grid.arrange(p1,p2.b,p3.b,p4,nrow=1)
dev.off()
```
