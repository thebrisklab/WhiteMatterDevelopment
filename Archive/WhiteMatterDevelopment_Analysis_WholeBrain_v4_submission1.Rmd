...
tiff('../Figures/GrowthCurveCorrectedAge.tiff',width=1080,height=640,pointsize=18)
par(mfrow=c(2,4))
...
tiff('../Figures/FA_Chron_GA_3d.tiff',width=1620,height=1350,pointsize=30)
...
plot_smooth(model0.fa, view="chor_age",cond=list(GA=35),col=cColors[1],rug=FALSE,ylim=c(0.12,0.205),lwd=2,se=0,ylab='Whole-brain FA',xlab='Chronological age (days)',hide.label=TRUE,main='B',xlim=c(2,201))

plot_smooth(model0.fa, view="chor_age", se=0,cond=list(GA=40),col=cColors[11],add=TRUE,rug=FALSE,lwd=2,xlim=c(2,201))
legend(x='bottomright',legend=c('GA=35','GA=40'),lty=1,lwd=2,col=cColors[c(1,11)],bty='n',cex=1)

(ga.35.fa=maxChronAgeMain(GAlow=35,GAhigh=40,model=model0.fa,ylab='FA 35 weeks - FA 40 weeks',main='C'))

plot_smooth(model0.fa, view="chor_age",cond=list(GA=35),col=cColors[1],rug=FALSE,ylim=c(0.12,0.205),lwd=2,se=0,ylab='Whole-brain FA',xlab='Chronological age (days)',hide.label=TRUE,main='D',xlim=c(2,201))

plot_smooth(model0.fa, view="chor_age", se=0,cond=list(GA=40),col=cColors[11],add=TRUE,rug=FALSE,lwd=2,xlim=c(2,201))
legend(x='bottomright',legend=c('GA=35','GA=40'),lty=1,lwd=2,col=cColors[c(1,11)],bty='n')
...
tiff('../Figures/GestationalAge_30_90_180.tiff',width=1080,height=640,pointsize=18)
par(mfrow=c(2,4))
...
######### FA:
cColors = viridis::plasma(15)
plot_smooth(model0.fa, view="chor_age",cond=list(GA=35),col=cColors[1],rug=FALSE,ylim=c(0.12,0.205),lwd=2,se=0,ylab='Whole-brain FA',xlab='Chronological age (days)',hide.label=TRUE,main='A',xlim=c(2,201))

plot_smooth(model0.fa, view="chor_age",cond=list(GA=36),col=cColors[3],add=TRUE,rug=FALSE,lwd=2,se=0,xlim=c(2,201))
...
######### MD:
plot_smooth(model0.md, view="chor_age", se=0, cond=list(GA=35),ylab='Whole-brain MD',xlab='Chronological age (days)',hide.label=TRUE,col=cColors[1],rug=FALSE,main='B',lwd=2,ylim=c(1,1.5),xlim=c(2,201))

plot_smooth(model0.md, view="chor_age", se=0, cond=list(GA=36),col=cColors[3],add=TRUE,rug=FALSE,lwd=2,xlim=c(2,201))
...
######### AD:
plot_smooth(model0.ad, view="chor_age", se=0,ylab='Whole-brain AD',xlab='Chronological age (days)',hide.label=TRUE, cond=list(GA=35),col=cColors[1],rug=FALSE,main='C',lwd=2,ylim=c(1.2,1.65),xlim=c(2,201))

plot_smooth(model0.ad, view="chor_age", se=0, cond=list(GA=36),col=cColors[3],add=TRUE,rug=FALSE,lwd=2,xlim=c(2,201))
...
######### RD:
plot_smooth(model0.rd, view="chor_age", se=0, cond=list(GA=35),hide.label=TRUE,xlab='Chronological age (days)',ylab='Whole-brain RD',col=cColors[1],add=FALSE,rug=FALSE, ylim=c(0.9,1.35),main='D',lwd=2,xlim=c(2,201))

plot_smooth(model0.rd, view="chor_age", se=0, cond=list(GA=36),col=cColors[3],add=TRUE,rug=FALSE,lwd=2,xlim=c(2,201))
...
, hide.label=TRUE,main='E',xlim=c(35,41),ylim=c(0.125,0.21),rug=FALSE,col='slateblue1')

focal_chron=90
plot_smooth(model0.fa, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain FA ',xlab='Gestational age at birth (weeks)'
, hide.label=TRUE,,xlim=c(35,41),rug=FALSE,col='slateblue3',add=TRUE)

focal_chron=180
plot_smooth(model0.fa, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain FA ',xlab='Gestational age at birth (weeks)'
, hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='darkslateblue',add=TRUE)

legend(x='bottomright',legend=c('30 days','90 days','180 days'),lty=1,lwd=2,col=c('slateblue1','slateblue3','darkslateblue'),bty='n')

focal_chron=30
plot_smooth(model0.md, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='F',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(0.95,1.4))

focal_chron=90
plot_smooth(model0.md, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD ',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='slateblue3',ylim=c(0.95,1.4),add=TRUE)

focal_chron=180
plot_smooth(model0.md, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='darkslateblue',ylim=c(0.95,1.4),add=TRUE)

focal_chron=30
plot_smooth(model0.ad, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='G',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(1.2,1.6))

focal_chron=90
plot_smooth(model0.ad, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD  age',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='slateblue3',add=TRUE)

focal_chron=180
plot_smooth(model0.ad, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='darkslateblue',add=TRUE)

focal_chron=30
plot_smooth(model0.rd, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='H',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(0.85,1.3))

focal_chron=90
plot_smooth(model0.rd, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='slateblue3',add=TRUE)

focal_chron=180
plot_smooth(model0.rd, view="GA",cond=list(chor_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='darkslateblue',add=TRUE)
...
```{r}
tiff('../Figures/GestandCorrectedAge_30_90_180.tiff',width=1080,height=640,pointsize=18)
par(mfrow=c(2,4))

######### FA:
cColors = viridis::plasma(15)
plot_smooth(model0.corr.fa, view="Corr_age",cond=list(GA=35),col=cColors[1],rug=FALSE,ylim=c(0.12,0.205),lwd=2,se=0,ylab='Whole-brain FA',xlab='Corrected age (days)',hide.label=TRUE,main='A')
...
focal_chron=30
plot_smooth(model0.corr.md, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='F',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(0.95,1.4))

focal_chron=90
plot_smooth(model0.corr.md, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD ',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='slateblue3',ylim=c(0.95,1.4),add=TRUE)

focal_chron=180
plot_smooth(model0.corr.md, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain MD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='darkslateblue',ylim=c(0.95,1.4),add=TRUE)

focal_chron=30
plot_smooth(model0.corr.ad, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='G',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(1.2,1.6))

focal_chron=90
plot_smooth(model0.corr.ad, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD  age',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='slateblue3',add=TRUE)

focal_chron=180
plot_smooth(model0.corr.ad, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain AD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='darkslateblue',add=TRUE)

focal_chron=30
plot_smooth(model0.corr.rd, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,main='H',xlim=c(35,41),rug=FALSE,col='slateblue1',ylim=c(0.85,1.3))

focal_chron=90
plot_smooth(model0.corr.rd, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='slateblue3',add=TRUE)

focal_chron=180
plot_smooth(model0.corr.rd, view="GA",cond=list(Corr_age=focal_chron),lwd=2,sim.ci=TRUE,ylab='Whole-brain RD',xlab='Gestational age at birth (weeks)',hide.label=TRUE,xlim=c(35,41),rug=FALSE,col='darkslateblue',add=TRUE)
...
```{r}
set.seed(1234)
tiff('../Figures/DiffCurves_CorrAge_FA.tiff',width=720,height=480,pointsize=20)
par(mfrow=c(2,3))

plot_diff(model=model0.corr.fa,view='Corr_age',comp=list(GA=c(35,40)),sim.ci = TRUE, hide.label=TRUE,xlab='Corrected age (days)',ylab='Est. difference in FA')
...
tiff('../Figures/DiffCurves_CorrAge_MD.tiff',width=720,height=480,pointsize=20)
par(mfrow=c(2,3))

plot_diff(model=model0.corr.md,view='Corr_age',comp=list(GA=c(35,40)),sim.ci = TRUE, hide.label=TRUE,xlab='Corrected age (days)',ylab='Est. difference in MD')
...
tiff('../Figures/DiffCurves_CorrAge_AD.tiff',width=720,height=480,pointsize=20)
par(mfrow=c(2,3))

plot_diff(model=model0.corr.ad,view='Corr_age',comp=list(GA=c(35,40)),sim.ci = TRUE, hide.label=TRUE,xlab='Corrected age (days)',ylab='Est. difference in AD')
...
tiff('../Figures/DiffCurves_CorrAge_RD.tiff',width=720,height=480,pointsize=20)
par(mfrow=c(2,3))

plot_diff(model=model0.corr.rd,view='Corr_age',comp=list(GA=c(35,40)),sim.ci = TRUE, hide.label=TRUE,xlab='Corrected age (days)',ylab='Est. difference in RD')
...
model.sex.ad = gam(WB_ad.combat~s(Corr_age,by=Sex)+s(Unique_ID,bs='re'),method='REML',data=dat_harmonized)
...
abline(v=25,lty=2,col='red',lwd=2)
